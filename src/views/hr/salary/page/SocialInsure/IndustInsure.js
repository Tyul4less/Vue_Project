            ...
            <div>
                <TableContainer component={Paper}>
                    <Table className={classes.table} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                <StyledTableCell align="center">산재 부담율</StyledTableCell>
                                <StyledTableCell align="center">출퇴근재해 요율</StyledTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {dataTest.map((row, index) => (
                                <StyledTableRow key={row.index}>
                                    <StyledTableCell align="center">
                                        {row.industinsureRates} %
                                    </StyledTableCell>
                                    <StyledTableCell align="center">
                                        {row.industinsurecharRates} %
                                    </StyledTableCell>
                                </StyledTableRow>
                            ))}
                        </TableBody>
