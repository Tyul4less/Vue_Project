...
const JournalGrid = ({ slipNo, flag ,searchJournal,searchSlipNo,approvalJournalList}) => {
  ...
  const onCellClicked = id => {
    ...
    searchJournal({journalNo: id.data.journalNo})
    ...
    <>
      ...
      >
        <AgGridReact
          ...
          rowData={approvalJournalList} // 그리드에 data 뿌림.
