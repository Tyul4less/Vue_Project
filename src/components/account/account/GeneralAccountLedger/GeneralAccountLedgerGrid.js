...
const GeneralAccountLedgerGrid = ({setGeneralAccountLedgerGrid,generalAccountLedgerList}) => {
      ...
      <div id="grid-wrapper" style={{ width: "100%" }}>
        ...
        >
          <AgGridReact
            ...
            rowData={generalAccountLedgerList}
            rowSelection="single"
            //onCellClicked={onCellClicked}
            onGridReady={params => {
              setGeneralAccountLedgerGrid(params.api);
              params.api.sizeColumnsToFit();
